module simple_card(
	input wire VCC,
	input wire GND,
	input reg clk,				// generated by motherboard clock generator
	input reg rst_n,			// probably a button on the motherboard
	input wire we,				// active high
	input wire oe,				// active high
	inout wire [7:0] data,
	input reg [15:0] addr,	    // 64k address space is suppored by default. More address bits may be added later
